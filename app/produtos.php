			...
			<table class="table table-striped">
			  	...
			  	<tbody>
					...
					<tr>
			      		...
			      		<td>
			      			<a>
			      				<span class="badge bg-success" onclick="modalView(<?=$row['id_produto']?>,'ver')">
			      					<i class="fas fa-eye" title="Visualizar"></i>
			      				</span>
			      			</a>

			      			<a>
			      				<span class="badge bg-primary" title="Editar" onclick="modalView(<?=$row['id_produto']?>,'editar')">
			      					<i class="fas fa-edit" title="Editar"></i>
			      				</span>
			      			</a>

			      			<a>
			      				<span class="badge bg-danger" onclick="modalView(<?=$row['id_produto']?>,'remover')">
...
<script>
    function modalView(id, tipo){
    	if (tipo == 'ver') {
    		$("#getModal").load('produtos/modal_ver.php?id='+id);
    	}
    	if (tipo == 'editar') {
    		$("#getModal").load('produtos/modal_editar.php?id='+id);
    	}
    	if (tipo == 'remover') {
    		$("#getModal").load('produtos/modal_remover.php?id='+id);
    	}
    	if (tipo == 'adicionar') {
    		$("#getModal").load('produtos/modal_adicionar.php?id='+id);
    	}
